      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3 mb-6">
        ...
        <div>
          <select 
            ...
            className="w-full px-4 py-2.5 rounded-xl bg-slate-50 border border-slate-200 text-slate-800 text-sm font-semibold outline-none cursor-pointer focus:border-slate-400 focus:ring-2 focus:ring-slate-200 transition-all"
          >
