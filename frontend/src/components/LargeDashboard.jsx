        ...
        <div>
          <div className="flex justify-between items-start">
            ...
            <select
              ...
              className="px-4 py-2.5 rounded-xl bg-slate-50 border border-slate-200 text-slate-800 text-sm font-semibold outline-none cursor-pointer focus:border-slate-400 focus:ring-2 focus:ring-slate-200 transition-all w-full"
            >
              {branchesList.map(b => (
