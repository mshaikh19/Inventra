      ...
      <main className="px-6 md:px-12 py-6 max-w-7xl mx-auto space-y-6">
        ...
        <div className="flex border-b border-slate-200 mb-6">
          <button
            ...
            className={`pb-3.5 px-6 text-xs font-black uppercase tracking-wider transition-all border-b-2 cursor-pointer ${
                    ...
                    <div className="flex flex-col items-center gap-5 max-w-md mx-auto">
                      ...
                      <div className="space-y-2">
                        ...
                        <p className="text-sm font-semibold text-slate-500 leading-relaxed">
                          ...
                          Managers get full branch control; employees get branch-scoped POS or inventory desk access based on their location type.
                        </p>
                      </div>
                      <button
                        onClick={openAddModal}
                        ...
                        <tr key={emp._id} className="hover:bg-slate-50/50 transition-colors group">
                          ...
                          <td className="px-5 py-4 text-right">
                            <div className="flex items-center justify-end gap-2">
                              ...
                              {emp.role !== "owner" && (isOwner || isManager) && (
                                <button
            ...
            <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
              <div className="flex items-center gap-2">
                ...
                <div>
                  ...
                  <p className="text-xs text-slate-550 font-semibold">Assign and track duties across your branch locations.</p>
                </div>
              </div>
              ...
              <div className="flex flex-wrap items-center gap-3">
                {/* Filter by Priority */}
                <div className="flex items-center gap-1.5">
                  <span className="text-[10px] font-black uppercase tracking-wider text-slate-405">Priority</span>
                  <CustomDropdown
                ...
                {/* Filter by Status */}
                <div className="flex items-center gap-1.5">
                  <span className="text-[10px] font-black uppercase tracking-wider text-slate-405">Status</span>
                  <CustomDropdown
                  ...
                  return (
                    <div
                      ...
                      className={`rounded-2xl border p-5 transition-all duration-300 flex flex-col justify-between shadow-sm relative overflow-hidden bg-white ${
                        isCompleted ? "border-slate-100 opacity-75" : "border-slate-200 hover:shadow-md hover:border-slate-350"
                      }`}
                    >
                      ...
                      <div>
                        ...
                        <div className="flex justify-between items-start gap-4">
                          ...
                          <button
                            ...
                            className="p-1.5 rounded-lg text-slate-450 hover:text-rose-600 hover:bg-rose-50 transition-all cursor-pointer"
                            title="Delete task"
                          >
                            <svg className="w-4.5 h-4.5" fill="none" stroke="currentColor" strokeWidth="2.5" viewBox="0 0 24 24">
                              <path strokeLinecap="round" strokeLinejoin="round" d="m14.74 9-.346 9m-4.788 0L9 9m9.968-3.21c.342.052.682.107 1.022.166m-1.022-.165L18.16 19.673a2.25 2.25 0 0 1-2.244 2.077H8.084a2.25 2.25 0 0 1-2.244-2.077L4.772 5.79m14.456 0a48.108 48.108 0 0 0-3.478-.397m-12 .562c.34-.059.68-.114 1.022-.165m0 0a48.11 48.11 0 0 1 3.478-.397m7.5 0v-.916c0-1.18-.91-2.164-2.09-2.201a51.964 51.964 0 0 0-3.32 0c-1.18.037-2.09 1.022-2.09 2.201v.916m7.5 0a48.667 48.667 0 0 0-7.5 0" />
                      ...
                      <div className="mt-5 pt-3.5 border-t border-slate-100 flex flex-col gap-2 text-[10px] font-bold text-slate-400">
                        <div className="flex justify-between items-center">
                          ...
                          <span className={`inline-flex items-center gap-1 rounded px-1.5 py-0.5 text-[8.5px] font-black uppercase tracking-wider ${
                            isCompleted ? "bg-emerald-50 text-emerald-700" : "bg-amber-50 text-amber-700 animate-pulse"
                          }`}>
