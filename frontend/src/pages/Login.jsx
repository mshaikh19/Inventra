...
import { hasSetupBranches } from "../utils/branches";
...
export default function Login({ setActiveTab }) {
  ...
  const handleSubmit = async (event) => {
    ...
    try {
      ...
      // Check if user has any branches set up and completed onboarding

      const hasBranches = await hasSetupBranches();
      ...
      if (!hasBranches || !onboardingCompleted) {
        ...
        <div className="space-y-4">
          ...
          <div>
            ...
            <FormInput
              ...
              className={fieldErrors.password ? "border-red-500 focus:border-red-500 focus:ring-red-100" : ""}
